"""Built-in hymns (public-domain text and traditional translations).

Only hymns whose original text is in the public domain are seeded here, using
widely-circulated traditional Chinese translations (§11 risk 3). Users add or
import other hymns at their own responsibility.
"""
...
def builtin_hymns() -> List[Hymn]:
    return [
        ...
        Hymn(
            id="builtin-to-god-be-the-glory",
            title="荣耀归于真神",
